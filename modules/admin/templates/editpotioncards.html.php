...
<div class="content admin-menu">
	<h4>Edit potion cards</h4>
	<div style="margin: 5px;">
		<a href="<?php echo make_url('new_card', array('card_type' => 'potion')); ?>" class="button button-silver">New card</a>
		<?php if (count($cards)): ?>
		...
		<?php else: ?>
			<p class="faded_out" style="margin-top: 10px;">There are no potion cards</p>
		<?php endif; ?>
	</div>
</div>