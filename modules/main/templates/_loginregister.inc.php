<div id="tab_register_pane"<?php if ($selected_tab != 'register'): ?> style="display: none;"<?php endif; ?>>
	<div style="vertical-align: middle; padding: 10px;" id="register">
		<form accept-charset="utf-8" action="<?php echo make_url('register'); ?>" method="post" id="register_form" onsubmit="Devo.Main.Login.register('<?php echo make_url('register'); ?>'); return false;">
