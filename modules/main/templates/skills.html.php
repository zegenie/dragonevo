...
<?php else: ?>
	<div class="content profile" style="padding: 10px;" id="available_skills">
		...
		<h2>
			...
			<span style="font-weight: normal; font-size: 0.7em;"><?php echo link_tag(make_url('profile'), '&laquo; Back to profile'); ?></span>
		</h2>
		<div id="skill_list">
