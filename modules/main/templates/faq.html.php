...
<div class="content full faq">
	...
	<h6>How many factions are there in Dragon Evo:TCG?</h6>
	<p>
		There are 3 main factions battling for power - these are The Hologev, The Rutai Empire and The Highwinds. For more information on the factions and their history, see the Game Guide (TBA).
	</p>
	<h6>Is Dragon Evo:TCG a "Facebook game"?</h6>
	<p>
	...
	<h6>How many races and classes can I choose from when creating my game character?</h6>
	<p>
		There will be 4 races and 4 different classes which you can choose for your character. You can read more about the races and classes in the Game guide section (TBA).
	</p>
	<h3 style="margin-top: 30px;">Release and testing</h3>
	<h6>When will the game be released?</h6>
	<p>
